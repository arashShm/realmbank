...
@section('content-section')
    ...
    <div class="card showCard">
        ...
        <div class="card-body">
            <a href="{{route('properties.destroy' , ['property' => $property->id ])}}" class="btn btn-outline-danger">Delete</a>
            <a href="{{route('properties.edit' , ['property' => $property->id ])}}" class="btn btn-outline-success">Edit</a>
        </div>
    </div>
@endsection
